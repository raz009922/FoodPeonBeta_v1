...
public class Kitchen_food_list extends AppCompatActivity /*implements SearchView.OnQueryTextListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kitchen_food_list);
        setupRecyclerView();
       /* SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(Kitchen_food_list.this);
        String PlaceName= preferences.getString("PlaceName","");
        setTitle("Current Adress: "+PlaceName);
        setTitleColor(R.color.colorPrimary);*/

        toolbar=findViewById(R.id.toolbarResturent);
        info=findViewById(R.id.buttonInfo);
        info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Kitchen_food_list.this,kitchen_info.class);
      ...
      /*  prepareActionBar(toolbar);*/
        ...
        call.enqueue(new Callback<List<Resturent>>() {
            ...
            public void onResponse(Call<List<Resturent>> call, final Response<List<Resturent>> response) {
                ...
                SwipeHelper swipeHelper = new SwipeHelper(Kitchen_food_list.this, recyclerView) {
                    @Override
                                ...
                                new UnderlayButtonClickListener() {
                                    ...
                                    public void onClick(int pos) {
                                        ...
                                        if(kitchenID>0){
                                            ...
                                            sqliteDatabaseAdapter=new SqliteDatabaseAdapter(Kitchen_food_list.this);
                                            ...
                                            if (id<0){
                                                Toast.makeText(Kitchen_food_list.this,
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* Intent foodlist =new Intent(MapsActivity.this,Food_Activity.class);
                ...
                /*Intent intent = new Intent(Food_Activity.this,Foods_under_a_kitchen.class);
                startActivity(intent);*/
            }
        });
